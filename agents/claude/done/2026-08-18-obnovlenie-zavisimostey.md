...
Итог: **обе непроверенные команды и одна красная должны быть подтверждены прогоном
непрерывной интеграции на pull request.** До зелёного прогона считать работу проверенной
нельзя.
